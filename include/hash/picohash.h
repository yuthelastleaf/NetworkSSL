...
static void _picohash_md5_init(void *vctx);
static void _picohash_md5_update(void *vctx, const void *data, size_t size);
static void _picohash_md5_final(void *vctx, void *digest);
...
static void _picohash_sha1_init(void *vs);
static void _picohash_sha1_update(void *vs, const void *input, size_t len);
static void _picohash_sha1_final(void *vs, void *digest);
...
static void _picohash_sha256_init(void *vctx);
static void _picohash_sha256_update(void *vctx, const void *data, size_t len);
static void _picohash_sha256_final(void *vctx, void *digest);
static void _picohash_sha224_init(void *vctx);
static void _picohash_sha224_final(void *vctx, void *digest);
...
inline void _picohash_md5_init(void *vctx)
{
    _picohash_md5_ctx_t* ctx = static_cast<_picohash_md5_ctx_t*>(vctx);
...
inline void _picohash_md5_update(void *vctx, const void *data, size_t size)
{
    _picohash_md5_ctx_t* ctx = static_cast<_picohash_md5_ctx_t*>(vctx);
...
inline void _picohash_md5_final(void *vctx, void *_digest)
{
    _picohash_md5_ctx_t* ctx = static_cast<_picohash_md5_ctx_t*>(vctx);
...
inline void _picohash_sha1_init(void *vs)
{
    _picohash_sha1_ctx_t* s = static_cast<_picohash_sha1_ctx_t*>(vs);
...
inline void _picohash_sha1_update(void *vs, const void *_data, size_t len)
{
    _picohash_sha1_ctx_t* s = static_cast<_picohash_sha1_ctx_t*>(vs);
...
inline void _picohash_sha1_final(void *vs, void *digest)
{
    _picohash_sha1_ctx_t* s = static_cast<_picohash_sha1_ctx_t*>(vs);
...
inline void _picohash_sha256_init(void *vctx)
{
    _picohash_sha256_ctx_t* ctx = static_cast<_picohash_sha256_ctx_t*>(vctx);
...
inline void _picohash_sha256_update(void *vctx, const void *data, size_t len)
{
    _picohash_sha256_ctx_t* ctx = static_cast<_picohash_sha256_ctx_t*>(vctx);
...
inline void _picohash_sha256_final(void *vctx, void *digest)
{
    _picohash_sha256_ctx_t* ctx = static_cast<_picohash_sha256_ctx_t*>(vctx);
...
inline void _picohash_sha224_init(void *vctx)
{
    _picohash_sha256_ctx_t* ctx = static_cast<_picohash_sha256_ctx_t*>(vctx);
...
inline void _picohash_sha224_final(void *vctx, void *digest)
{
    _picohash_sha256_ctx_t* ctx = static_cast<_picohash_sha256_ctx_t*>(vctx);
...
inline void picohash_init_md5(picohash_ctx_t *ctx)
{
    ...
    memset(&ctx->_md5, 0, sizeof(_picohash_md5_ctx_t));
...
static void _picohash_hmac_final(void *vctx, void *digest)
{
    picohash_ctx_t* ctx = static_cast<picohash_ctx_t*>(vctx);
...
static inline void _picohash_hmac_reset(void *vctx)
{
    picohash_ctx_t* ctx = static_cast<picohash_ctx_t*>(vctx);
